...
public class MeatSupremePizza implements Pizza{
	...
	private String size;
	public MeatSupremePizza(String size){
	...
	public double Price() {
		...
		ingredients[2] = "tomato sauce";
		ingredients[3] = "Italian sausage";
		ingredients[4] = "green pepper";
		ingredients[5] = "pepperoni";
		ingredients[7] = "bacon";
